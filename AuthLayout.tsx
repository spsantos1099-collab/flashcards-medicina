  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-10">
            ...
            <p className="mt-1 text-sm text-ink-400">Seu espaço de estudo</p>
          </div>
          <Outlet />
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-col justify-between bg-ink-900 text-paper px-14 py-14 relative overflow-hidden">
        <div className="source-tab text-ink-200">SEU FICHÁRIO DE ESTUDOS</div>
        ...
        <div className="max-w-md">
          ...
          <p className="mt-5 text-sm leading-relaxed text-ink-200 max-w-sm">
            Flashcards, revisão espaçada e organização dos seus estudos em um só lugar.
          </p>
        </div>

        <div className="source-tab text-ink-200">
          SEU MATERIAL · SEUS CARDS · SUAS REVISÕES
        </div>
      </div>
    </div>
  );
