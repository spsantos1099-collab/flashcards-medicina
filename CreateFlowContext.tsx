...
interface CreateFlowContextValue {
  ...
  researchSearchMeta: ResearchSearchMeta | null;
  ...
  setSelectedResearchSourceIds: (ids: string[]) => void;
  setResearchSearchMeta: (meta: ResearchSearchMeta | null) => void;
  reset: () => void;
}
...
export function CreateFlowProvider({ children }: { children: ReactNode }) {
  ...
  const [researchSearchMeta, setResearchSearchMeta] = useState<ResearchSearchMeta | null>(null);
...
export function useCreateFlow() {
  ...
  if (!context) throw new Error("useCreateFlow precisa estar dentro de <CreateFlowProvider>");
  return context;
}
